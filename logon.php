...
if(isset($_POST['submit'])){
    ...
    if ($number==''||$password=='') {
        ...
        if(mysqli_num_rows($res)!=0){
            echo "<script>alert('账号重复，请重新注册');</script>";
        }
        else{
            $sql="INSERT INTO user (`number`,password) VALUES ('$number','$password')";
        ...
        <div class="item">
            ...
            <table cellspacing="0">
                <tr style="width: 280px;height: 60px;">
                    <td colspan="2" style="font-weight: 900;font-size:25px;">用户注册</td>
                </tr>
                <tr style="width: 280px;height: 60px;">
                ...
                <tr style="width: 280px;height: 60px;">
                    <td colspan="2">
                    <input type="submit" name="submit" value="注册" style="width: 262px; height: 44px; font-size: 20px;background-color: red;color: white;border: 0;">
                    </td>
                </tr>
            </table>
            </form>
