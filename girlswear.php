...
$sql="SELECT * FROM commodity WHERE label='热卖女装'";
        ...
        <div class="box">
            <div class="menu">
                <ul>
                    ...
                    <li><a href="menswear.php" target="_blank">男装<table><tr><td>
                        <ul>
                            <li><a href="#">毛衣</a></li>
                            <li><a href="#">卫衣</a></li>
                            <li><a href="#">裤子</a></li>
                    ...
                    <li><a href="girlswear.php" target="_self">女装<table><tr><td>
                        <ul>
                            <li><a href="#">毛衣</a></li>
                            <li><a href="#">卫衣</a></li>
                            <li><a href="#">裤子</a></li>
