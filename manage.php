...
if (isset($_SESSION['user_id'])) {
    ...
    $sql="SELECT * FROM commodity WHERE user_id=$user_id";
            ...
            <div class="container">
                ...
                <div class="row cart">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="col-md-3 ">参考价</div>
                        <div class="col-md-3 ">修改</div>
                        <div class="col-md-3 "><a href="addition.php" style="text-decoration: none;color: #444;">添加</a></div>
                    </div>
                </div>
<?php
                ...
                <div class="header-a">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="col-md-3 money">&nbsp;￥<?php echo $row['original']; ?></div>
                            <div class="col-md-3 main">
                                <ul>
                                    <li>
                                    	<form action="revise.php" method="post">
                                            &nbsp;&nbsp;
                                    		<input type="submit" name="submit" value="修改" style="background:transparent;border:0">
